...
pokemon_parser = subparsers.add_parser("pokemon", help="Favourite Pokemon")
pokemon_parser.add_argument("fav_pokemon",type=str, help="Your favourite Pokemon")
...
if args.command == "pokemon":
    print(f"Your favourite pokemon is {args.fav_pokemon}")
